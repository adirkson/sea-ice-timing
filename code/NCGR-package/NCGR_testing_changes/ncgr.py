...
class ncgr_fullfield():    
    ...
    Args:
        hc_netcdf (str):
            Path to the NetCDF file containing the model hindcast IFD or FUD 
            fields to be used for training NCGR. This file should contain 
            several years of ensemble IFD or FUD hindcast fields
            for a single start date. 
            
        obs_netcdf (str):
            Path to the NetCDF file containing the observed IFD or FUD fields 
            to be used for training NCGR. This file should contain several years 
            of observed IFD or FUD fields corresponding
        ...
        out_netcdf (str):
            Path to a to-be-created NetCDF file that will be written and will
            contain several outputs related to the calibrated forecast field.
    ...
    >>> si_time = sitdates.sitdates(event=event) # instantiate the sitdates class
